...
<body>
    ...
    <div class="container">
        ...
        <?php endif; ?>
        <!-- si l'utilisateur vient de s'enregistrer avec succès, on affiche un message de succès -->
        <?php if (isset($_SESSION['registration_success'])) {
            echo '<p class="alert alert-success">' . $_SESSION['registration_success'] . '</p>';
        ...
        <?php if (!isset($_SESSION['LOGGED_USER'])) : ?>
            ...
            <?php endif; ?>
            <div>
                <p>Vous n'avez pas de compte ? <a href="/register">Faites une demande de création de compte en ligne</a></p></br>
            </div>
