...
<body>
    ...
    <div class="container">
        ...
        <p>Le Dr. Dupont a obtenu son diplôme de médecine à l'Université de Paris. Il a ensuite complété sa résidence à l'Hôpital Saint-Louis, où il s'est spécialisé en Orthodontie.</p>
        <h2>Qualifications</h2>
        <ul>
            <li>Docteur en médecine</li>
            <li>Spécialiste en Orthodontie</li>
            <li>Membre de l'Association française d'Orthodontie</li>
        </ul>
